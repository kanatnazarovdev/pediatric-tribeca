...
export const metadata: Metadata = {
  ...
  description: "Meet the expert pediatric dentists at Tribeca Dental Studio. We specialize in fear-free kids' dentistry, airway health, and laser treatments in Lower Manhattan.",
  openGraph: {
    title: "Expert Pediatric Dentists in Tribeca | Tribeca Dental Studio 4 kids",
    description: "Get to know our specialized team of children's dentists. From first visits to growth-centric airway care, we provide the best pediatric dental experience in NYC.",
